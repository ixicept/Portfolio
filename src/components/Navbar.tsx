...
const Navbar: React.FC = () => {
  const linkClass = ({ isActive }: { isActive: boolean }) =>
    `relative px-1 py-1 text-sm font-thin sm:px-0 sm:py-1 sm:text-base
  ...
  return (
    ...
    >
      <div className="bg-stone-900 rounded-xl px-4 py-2 mt-3 shadow-md inline-block sm:px-6 sm:py-3 sm:mt-4 opacity-75">
